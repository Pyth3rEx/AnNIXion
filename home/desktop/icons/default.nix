...
let
  ...
  # them; both values are the prompt's (home/shell/omp-theme.nix:37).
  classColour = {
    passive = "#33E62B";
    probe = "#FFD000";
    offensive = "#FF0033";
  ...
  # scripts/mark-bbox.py enforces both halves of this.
  ...
  # that entry declares, and home/desktop/plasma.nix pins those entries on purpose:
