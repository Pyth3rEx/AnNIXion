...
in
{
  programs.konsole = {
    enable = true;
    customColorSchemes = {
      BreezeTransparent = breezeTransparent;

      # A root shell should never be mistaken for the operator's.
      BreezeRoot = lib.recursiveUpdate breezeTransparent {
        General.Description = "Breeze Root";
        Background.Color = "48,18,18";
        BackgroundFaint.Color = "66,28,28";
        BackgroundIntense.Color = "26,0,0";
        Foreground.Color = "252,236,236";
      };
    };
