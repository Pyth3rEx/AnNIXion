# home/default.nix — the operator user's environment.
...
let
  ...
  AnNIXionIcons = import ./desktop/icons { inherit pkgs lib; };
...
in
{
  imports = [
    ...
    ./desktop/control-center.nix
    ./apps/fastfetch.nix
    ./shell
    ./desktop/file-visibility.nix
    ./apps/konsole.nix
  ...
  # ── User packages ─────────────────────────────────────────
  # Offensive/OSINT/SDR tooling is system-wide, in system/security-tools.nix.
  # The CLI the shell config leans on is system-wide, in system/shell.nix,
